const items = [
  ...
  { name: '力量果实', type: 'food', effect_type: 'attack', effect_value: 1, price: 500, description: '永久提升1点攻击力', rarity: 'legendary', image_url: '/images/items/力量果实.png' },
  { name: '铁骨果实', type: 'food', effect_type: 'defense', effect_value: 1, price: 500, description: '永久提升1点防御力', rarity: 'legendary', image_url: '/images/items/铁骨果实.png' },
  { name: '疾风果实', type: 'food', effect_type: 'speed', effect_value: 1, price: 500, description: '永久提升1点速度', rarity: 'legendary', image_url: '/images/items/疾风果实.png' },
  ...
  { name: '万灵药', type: 'potion', effect_type: 'health', effect_value: 100, price: 300, description: '恢复满健康值、满饱腹度、满心情', rarity: 'epic', image_url: '/images/items/万灵药.png' },
  { name: '营养套餐', type: 'food', effect_type: 'hunger', effect_value: 60, price: 80, description: '营养均衡的套餐，恢复60饱腹度和30心情', rarity: 'rare', image_url: '/images/items/营养套餐.png' },
  { name: '满汉全席', type: 'food', effect_type: 'hunger', effect_value: 100, price: 500, description: '顶级盛宴，恢复满饱腹度、满心情、满体力', rarity: 'legendary', image_url: '/images/items/满汉全席.png' },
